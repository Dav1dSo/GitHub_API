...
class SearchController extends Controller
{
    ...
    public function ServiceApi(Request $request) {
        ...
        $response = Http::withToken('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')->get("https://api.github.com/users/{$Search}/repos");
        ...
        foreach($repositorios as $repos){
            ...
            $commitsUrl = Http::withtoken('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')->get("https://api.github.com/repos/{$Search}/{$repos['name']}/commits");
